...
\begin{document}
	...
	\begin{corollary}[理想的充要条件]
		设$R$是环，$I$是$R$的非空子集，则$I$是$R$的理想当且仅当对任意$a,b\in I$，任意$x,y\in R$，有$a-b\in I,xa,ay\in I$.
	\end{corollary}
	\begin{theorem}
		两个理想之交仍是理想.
	\end{theorem}
	\begin{proof}
		设$I_1,I_2\lhd R$，若$I_1\cap I_2=\left\{e\right\}$，则是平凡理想.反之，可设$a,b\in I_1\cap I_2$，$x,y\in R$.由$I_1\lhd R$，$a,b\in I_1$，有$a-b\in I_1$，$xa,ay\in I_1$.同理，有$a,b\in I_2$，$xa,ay\in I_2$，于是$a-b\in I_1\cap I_2$，$xa,ay\in I_1\cap I_2$.由理想的充要条件，$I_1\cap I_2\lhd R$.
	\end{proof}
	\begin{corollary}
		任意多个理想的交仍是理想.
	\end{corollary}
